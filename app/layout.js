      ...
      <body>
        ...
        <footer className="footer">
          <div className="footer-inner">
            ...
            <div className="footer-links"><strong>aulaia.cat</strong><Link href="/#apps">Cataleg</Link><Link href="/contacte">Demo</Link></div>
          ...
          <p className="footer-copy">© {new Date().getFullYear()} aulaia.cat</p>
        </footer>
      </body>
    </html>
  );
